...
do_deploy() {
	if [ -e ${S}/${PATH_EEPROM}/${SOM_EEPROM} ]; then
		install -Dm 0644 ${S}/${PATH_EEPROM}/${SOM_EEPROM} ${DEPLOYDIR}/som-k24-eeprom-${DEPLOY_SUFFIX}.bin
		ln -sf som-k24-eeprom-${DEPLOY_SUFFIX}.bin ${DEPLOYDIR}/som-k24-eeprom.bin
	else
