...
for mach in ${!MACHINES[@]}; do
  ...
  url=${URLS[${mach}]}
  url=$(echo $url | sed 's,https://petalinux.xilinx.com/sswreleases/rel-v2024/hdf-examples,https://artifactory.xilinx.com/artifactory/petalinux-hwproj-dev/hdf-examples,')
