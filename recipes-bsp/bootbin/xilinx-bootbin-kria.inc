...
ADDN_COMPILE_DEPENDS:kria = "bootbin-version-header:do_deploy fsbl:do_deploy pmufw:do_deploy arm-trusted-firmware:do_deploy u-boot-xlnx:do_deploy device-tree:do_deploy"
